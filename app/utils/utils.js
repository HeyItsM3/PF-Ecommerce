...
const sendRegisterEmail = (name, email) => {
  transporter.sendMail({
    ...
    * {
    ...
    <p style="font-size: 14px; line-height: 140%;">&nbsp;</p>
    <p style="font-size: 14px; line-height: 140%;"><span style="font-size: 16px; line-height: 22.4px;">Tu registro est&aacute; casi completo, para finalizar por favor presioná 'Terminar registro' y lo enviaremos directamente a nuestra p&aacute;gina web para que puedas navegar y comprar los mejores celulares.</span></p>
    <p style="font-size: 14px; line-height: 140%;">&nbsp;</p>
    <p style="font-size: 14px; line-height: 140%;">&nbsp;</p>
      </div>
